 ...
 * (BPMP), lalu Unggah Dokumen. BPMP, BP21, dan BPA2 sudah punya halaman
 * sungguhan; sisanya menuju halaman "segera hadir" (lihat `ComingSoonNotice`)
...
export const EBUPOT_MENU: NavSubItem[] = [
  ...
  { label: 'BPA2 - Bukti Pemotongan A2 Masa Pajak Terakhir', href: '/ebupot/bpa2' },
